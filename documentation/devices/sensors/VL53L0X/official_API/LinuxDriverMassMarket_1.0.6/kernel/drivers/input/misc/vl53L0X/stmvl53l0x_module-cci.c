/*
 *  stmvl53l0x_module-cci.c - Linux kernel modules for STM VL53L0 FlightSense TOF
 *							sensor
 *
...
#include "../../../../../../../official_API/LinuxDriverMassMarket_1.0.6/kernel/drivers/input/misc/vl53L0X/inc/vl53l0x_api.h"
/*
 * API includes
 */

#include "../../../../../../../VL53L0X_1.0.2-offical-API/LinuxDriverMassMarket_1.0.6/kernel/drivers/input/misc/vl53L0X/inc/vl53l0x_def.h"
#include "../../../../../../../VL53L0X_1.0.2-offical-API/LinuxDriverMassMarket_1.0.6/kernel/drivers/input/misc/vl53L0X/inc/vl53l0x_platform.h"
#include "../../../../../../../VL53L0X_1.0.2-offical-API/LinuxDriverMassMarket_1.0.6/kernel/drivers/input/misc/vl53L0X/stmvl53l0x.h"
#include "../../../../../../../VL53L0X_1.0.2-offical-API/LinuxDriverMassMarket_1.0.6/kernel/drivers/input/misc/vl53L0X/stmvl53l0x-cci.h"
#include "../../../../../../../VL53L0X_1.0.2-offical-API/LinuxDriverMassMarket_1.0.6/kernel/drivers/input/misc/vl53L0X/stmvl53l0x-i2c.h"
...
{
	vl53l0x_dbgmsg("Subdev_ioctl not handled\n");
	return 0;
}

static int32_t msm_tof_power(struct v4l2_subdev *sd, int on)
{
	vl53l0x_dbgmsg("TOF power called\n");
	return 0;
}
...
static int stmvl53l0x_cci_init(struct cci_data *data)
{
	...
	if (FALSE == data->subdev_initialized) {
		...
		if (!data->client->cci_client) {
			vl53l0x_errmsg("%d, failed no memory\n", __LINE__);
			return -ENOMEM;
		}
	...
	if (rc < 0) {
		vl53l0x_errmsg("%d: CCI Init failed\n", __LINE__);
		return rc;
	}
	vl53l0x_dbgmsg("CCI Init Succeeded\n");
...
{
	struct stmvl53l0x_data *vl53l0x_data = platform_get_drvdata(pdev);

	stmvl53l0x_cleanup(vl53l0x_data);
...
int stmvl53l0x_power_up_cci(void *cci_object, unsigned int *preset_flag)
{
	...
	if (ret) {
		vl53l0x_errmsg("stmvl53l0x_cci_init failed %d\n", __LINE__);
		return ret;
	}
	/* actual power up */
	if (data && data->device_type == MSM_CAMERA_PLATFORM_DEVICE) {
		...
		if (ret < 0) {
			vl53l0x_errmsg("stmvl53l0x_vreg_control failed %d\n",
				__LINE__);
			return ret;
		}
	}
...
int stmvl53l0x_power_down_cci(void *cci_object)
{
	...
	if (data->power_up) {
		...
		ret = data->client->i2c_func_tbl->i2c_util(data->client,
				MSM_CCI_RELEASE);
		if (ret < 0)
			vl53l0x_errmsg("CCI Release failed rc %d\n", ret);
